...
PREFIX = re.compile(r'^(นางสาว|นาง|นาย|พลตำรวจเอก|พลตำรวจโท|พลตำรวจตรี|พลเอก|พลโท|พลตรี|พลเรือเอก|พลเรือโท|พลอากาศเอก|พลอากาศโท|'
                    r'ศาสตราจารย์|รองศาสตราจารย์|ผู้ช่วยศาสตราจารย์|ดร\.|แพทย์หญิง|นายแพทย์)\s*')
